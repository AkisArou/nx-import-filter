...
import { ensureGlobalProjectGraph } from '@nx/eslint-plugin/src/utils/project-graph-utils';
...
function init(modules: {
  ...
  function create(info: ts.server.PluginCreateInfo) {
    ...
    log('Initializing nx import-filter typescript language service plugin');
    ...
    ensureGlobalProjectGraph(RULE_NAME);
